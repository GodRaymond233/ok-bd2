...
SANDBOX_SKILL_SLOT_2_REFERENCE_CENTER = (1748, 1010)
SANDBOX_SKILL_SLOT_1_RELATIVE_POINT = (
    SANDBOX_SKILL_SLOT_1_REFERENCE_CENTER[0] / 1920,
    SANDBOX_SKILL_SLOT_1_REFERENCE_CENTER[1] / 1080,
)
...
SANDBOX_TELEPORT_SKILL_REFERENCE_CENTER = (1793, 789)
SANDBOX_TELEPORT_SKILL_RELATIVE_POINT = (
    SANDBOX_TELEPORT_SKILL_REFERENCE_CENTER[0] / 1920,
    SANDBOX_TELEPORT_SKILL_REFERENCE_CENTER[1] / 1080,
)
